/**
 * hbr_merge_cli_new.js  —  HBR Studio Merge CLI  (v3)
 *
 * Usage:
 *   node hbr_merge_cli_new.js <output.hbr2> <file1.hbr2> <file2.hbr2>
 *
...
if (args.length < 3) {
  emit({ type: 'error', message: 'Usage: node hbr_merge_cli_new.js <output> <file1> <file2>' });
  process.exit(1);
}
